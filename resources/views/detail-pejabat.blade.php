      ...
      <div class="max-w-6xl mx-auto p-10">
            <div class="mx-auto flex flex-col md:flex-row justify-between ">
                  <div class="w-full md:w-3/4 mr-0 md:mr-8">
                        <div class="py-10">
                              <div class="text-blue-800 space-y-4 mb-10">
                                    <h3 class="font-bold text-xl">Profil {{ $pejabat->jabatan }}</h3>
                                    <h1 class="font-bold text-4xl">{{ $pejabat->nama }}</h1>
                              </div>
                              <div class="column-4 text-center w-full  justify-center">
                                    <img class="rounded-full w-72 mx-auto" src="{{ asset('storage/'. $pejabat->image) }}" alt="">
                              </div>
                              <div class="flex font-semibold text-lg mt-10">
                                    <div class="mr-10 space-y-5">
                                          <div>Nama</div>
                                          <div>Jabatan</div>
                                          <div>Tempat/Tahun Lahir</div>
                                    </div>
                                    <div class="mr-10 space-y-5">
                                          <div>:</div>
                                          <div>:</div>
                                    ...
                                    <div class="space-y-5">
                                          ...
                                          <div>{{ $pejabat->tempat_thn_lahir }}</div>
                                    </div>
                              </div>
                              <div class="mt-10">
                                    {!! $pejabat->info !!}
